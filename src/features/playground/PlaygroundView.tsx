...
export default function PlaygroundView() {
  ...
  const [recentIngestsRefresh, setRecentIngestsRefresh] = useState(0)
  ...
  const handleIngestSuccess = (response: IngestResponse, source: string, title?: string) => {
    ...
    // Refresh recent ingests list
    setRecentIngestsRefresh(prev => prev + 1)
    addToast({
  ...
  const handleRecentIngestSelect = (ingest: RecentIngest) => {
              ...
              {messages.length > 0 && (
                <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors flex items-center gap-2"
                    title="Download transcript as .md file"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  {filtersExpanded && (
                    <div className="space-y-3">
                      ...
                      <div className="pt-3 border-t">
                        <RecentIngests
                          onSelect={handleRecentIngestSelect}
                          refreshTrigger={recentIngestsRefresh}
                        />
                      </div>
                    </div>
                  )}
