...
**Operational add-ons:** after baseline deploy, use **[RUNBOOK.md](./RUNBOOK.md)** (incidents and example SLOs) and **[HARDENING.md](./HARDENING.md)** (`API_KEY`, rate limits, tenancy, and the threat model).
